...
An AI-powered full-stack application that intelligently converts **any CSV format** into a standardized CRM schema using **AI (OpenRouter/Groq/Gemini)**.
...
- 📘 TypeScript
- 📤 Multer
- 🤖 OpenRouter AI (with Groq/Gemini fallback)
- ✅ Zod Validation
...
💼 LinkedIn: anshuman-tiwari-41bb64368
